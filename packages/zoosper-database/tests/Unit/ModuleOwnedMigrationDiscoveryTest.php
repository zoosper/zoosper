 ...
 * to match the depth used below (dirname(__DIR__, 4) from
 ...
 * MethodPluginModuleDiscoveryTest.php uses dirname(__DIR__, 4) from
 * tests/Unit/Plugin/.
 */
it('discovers and applies migrations from each module\'s own database/migrations folder', function (): void {
    $basePath = dirname(__DIR__, 4); // repo root — adjust if your test tree depth differs
