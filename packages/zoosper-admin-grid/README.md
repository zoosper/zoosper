...
### Fable hierarchy pass

The final package-owned polish layer provides a calmer command surface, sticky desktop headings, clearer row tracking and a contained pagination surface. It changes presentation only; query state, saved views, column preferences, selection, export, permissions, CSRF and audit behaviour remain unchanged.
