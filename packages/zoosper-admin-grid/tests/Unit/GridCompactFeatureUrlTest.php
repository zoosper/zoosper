...
it('preserves the established Pages export by default',function():void{$html=(new GridCompactWorkspaceRenderer())->render(featureUrlState(),'/admin/pages');expect($html)->toContain('href="/admin/pages">Clear all</a>')->toContain('href="/admin/pages/export"')->toContain('data-grid-export');});
