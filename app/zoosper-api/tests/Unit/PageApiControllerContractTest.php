...
it('requires PAT scope and owner permission while preserving Site isolation and structured content', function (): void {
    $source=(string)file_get_contents(dirname(__DIR__,2).'/src/Controller/PageApiController.php');
    expect($source)->toContain("allows('pages:read')")->toContain("can('page.view')")->toContain("can('page.manage')")
