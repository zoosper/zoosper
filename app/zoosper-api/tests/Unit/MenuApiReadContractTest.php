...
it('exposes stateless PAT Menu list detail and tree reads with Site isolation',function():void{
 $root=dirname(__DIR__,4);$routes=(string)file_get_contents($root.'/app/zoosper-api/config/api_routes.php');$controller=(string)file_get_contents($root.'/app/zoosper-api/src/Controller/MenuApiController.php');$wiring=(string)file_get_contents($root.'/app/zoosper-api/config/controllers.php');
