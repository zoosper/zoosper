...
{
    public function __construct(private ?CsrfTokenManager $csrf = null)
    {
    }
    ...
    public function render(
        ...
        if ($this->csrf !== null) {
            $html .= '<input type="hidden" name="_csrf_token" value="' . htmlspecialchars($this->csrf->token(), ENT_QUOTES) . '">';
        }
