...
afterEach(function():void{foreach(['APP_ENV','APP_DEBUG','SESSION_SECURE','RATE_LIMIT_ENABLED','RATE_LIMIT_MODE','RATE_LIMIT_IDENTITY_SALT','TWO_FACTOR_ENCRYPTION_KEY','DB_DRIVER'] as $key){unset($_ENV[$key]);putenv($key);}putenv('APP_ENV=testing');});
