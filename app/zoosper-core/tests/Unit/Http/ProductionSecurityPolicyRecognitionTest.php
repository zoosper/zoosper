...
afterEach(function():void{foreach(['APP_ENV','SESSION_SECURE','RATE_LIMIT_ENABLED','RATE_LIMIT_MODE','RATE_LIMIT_IDENTITY_SALT'] as $key){unset($_ENV[$key]);putenv($key);}putenv('APP_ENV=testing');});
