...
it('wires Settings forms scope redirects and template navigation through canonical URLs', function (): void {
    ...
    $controller = (string) file_get_contents($root . '/app/zoosper-settings/src/Controller/SettingsCatalogueController.php');
    ...
    expect($controller)->toContain('private ?AdminUrlGenerator $adminUrls = null')
        ->toContain("\$this->adminUrl('settings', ['scope' => \$type, 'scope_key' => \$key])")
