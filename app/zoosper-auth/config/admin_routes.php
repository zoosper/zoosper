...
return [
    ['method' => 'GET', 'path' => '/admin/users', 'controller' => UserAdminController::class, 'action' => 'index', 'permission' => 'user.manage'],
    ['method' => 'GET', 'path' => '/admin/users/create', 'controller' => UserAdminController::class, 'action' => 'createForm', 'permission' => 'user.manage'],
    ['method' => 'POST', 'path' => '/admin/users/create', 'controller' => UserAdminController::class, 'action' => 'create', 'permission' => 'user.manage'],
    ['method' => 'GET', 'path' => '/admin/users/edit', 'controller' => UserAdminController::class, 'action' => 'editForm', 'permission' => 'user.manage'],
    ['method' => 'POST', 'path' => '/admin/users/edit', 'controller' => UserAdminController::class, 'action' => 'update', 'permission' => 'user.manage'],
