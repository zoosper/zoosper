...
final readonly class PageGridDefinition
{
    ...
    public function __construct(private ?GridColumnRegistry $columns=null,private ?PageGridSiteFilter $siteFilter=null){}
    public function build():GridDefinition
    {
        $definition=new GridDefinition(
            ...
            columns:[
                ...
                new GridColumn('actions','Actions',toggleable:false,render:static function(mixed $value,array $row):string{$id=(int)($row['id']??0);return '<a href="/admin/pages/edit?id='.$id.'">Edit</a> &nbsp;|&nbsp; <a href="/admin/pages/preview?id='.$id.'" target="_blank" rel="noopener">Preview</a>';})
            ],
            filters:[
