...
return [
    ...
    ['method' => 'POST', 'path' => '/api/v1/pages/{id:\d+}/archive', 'controller' => PageApiController::class, 'action' => 'archive', 'public' => true, 'stateless' => true],
    ['method' => 'POST', 'path' => '/api/v1/pages/{id:\d+}/restore', 'controller' => PageApiController::class, 'action' => 'restoreArchived', 'public' => true, 'stateless' => true],
    ['method' => 'DELETE', 'path' => '/api/v1/pages/{id:\d+}', 'controller' => PageApiController::class, 'action' => 'deletePermanently', 'public' => true, 'stateless' => true],
