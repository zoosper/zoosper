...
it('consumes the shared scope repository and derives the Default SMTP service from the factory', function (): void {
    $root = dirname(__DIR__, 5);
    $services = file_get_contents($root . '/app/zoosper-mail/config/services.php');

    expect(substr_count($services, 'new ScopeConfigRepository('))->toBe(0)
