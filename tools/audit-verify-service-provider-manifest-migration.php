...
/**
 * Audit replacement Pest coverage for tools/verify-service-provider-manifest-file.php.
 *
...
$coverageTest = 'app/zoosper-core/tests/Unit/Tools/LegacyVerifyServiceProviderManifestCoverageTest.php';
$statusDoc = 'docs/development/legacy-verify-migration-status.md';
$migrationDoc = 'docs/development/verify-service-provider-manifest-migration.md';
...
$txtPath = rtrim($outputDir, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'verify-service-provider-manifest-migration.txt';
$logPath = rtrim($outputDir, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'verify-service-provider-manifest-migration.log';

$report = [];
$report[] = '# Verify Service Provider Manifest Migration Evidence';
$report[] = '';
...
$log = [];
$log[] = 'Verify service provider manifest migration evidence written to: ' . $txtPath;
