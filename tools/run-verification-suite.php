...
$commands = [
    ...
    ['Syntax: apply-admin-notice-success-css.php', [$php, '-l', 'tools/apply-admin-notice-success-css.php']],
    ['Syntax: verify-admin-notice-success-css.php', [$php, '-l', 'tools/verify-admin-notice-success-css.php']],
    ['Syntax: verify-admin-user-locale-persistence-readiness.php', [$php, '-l', 'tools/verify-admin-user-locale-persistence-readiness.php']],
    ...
    ['Verify: admin user locale persistence readiness', [$php, 'tools/verify-admin-user-locale-persistence-readiness.php']],
