...
$commands = [
    ...
    ['Syntax: apply-safe-user-admin-locale-ui-position-hotfix.php', [$php, '-l', 'tools/apply-safe-user-admin-locale-ui-position-hotfix.php']],
    ['Syntax: diagnose-safe-user-admin-locale-ui-position.php', [$php, '-l', 'tools/diagnose-safe-user-admin-locale-ui-position.php']],
    ['Syntax: verify-safe-user-admin-locale-html-position.php', [$php, '-l', 'tools/verify-safe-user-admin-locale-html-position.php']],
