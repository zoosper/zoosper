...
print "Zoosper Editor.js JSON save pipeline diagnostics\n";
print "================================================\n\n";
...
if (zoosper_phase077_column_exists($pdo, 'pages', 'content_json')) {
    $rows = $pdo->query("SELECT id, slug, content_format, content_json IS NOT NULL AND content_json <> '' AS has_json FROM pages ORDER BY id ASC")->fetchAll();
    foreach ($rows as $row) {
