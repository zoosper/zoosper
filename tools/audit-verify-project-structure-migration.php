...
/**
 * Audit replacement Pest coverage for tools/verify-project-structure.php.
 *
...
$legacyScript = 'tools/verify-project-structure.php';
$coverageTest = 'app/zoosper-core/tests/Unit/Tools/LegacyVerifyProjectStructureCoverageTest.php';
$statusDoc = 'docs/development/legacy-verify-migration-status.md';
$migrationDoc = 'docs/development/verify-project-structure-migration.md';
...
$report = [];
$report[] = '# Verify Project Structure Migration Evidence';
$report[] = '';
