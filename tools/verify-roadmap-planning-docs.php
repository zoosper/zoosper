...
$checks = [
    ...
    'roadmap includes extension data phase' => str_contains($roadmap, 'Entity Extension Data Persistence Table') || str_contains($roadmap, 'Entity extension data persistence foundation'),
