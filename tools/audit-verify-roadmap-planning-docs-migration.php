...
/**
 * Audit replacement Pest coverage for tools/verify-roadmap-planning-docs.php.
 *
...
$legacyScript = 'tools/verify-roadmap-planning-docs.php';
...
$logPath = rtrim($outputDir, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'verify-roadmap-planning-docs-migration.log';

$report = [];
$report[] = '# Verify Roadmap Planning Docs Migration Evidence';
$report[] = '';
...
$log = [];
$log[] = 'Verify roadmap planning docs migration evidence written to: ' . $txtPath;
